...
bool isValidNatural(pao_Natural* n) {
  ...
  u32 i = 0;
  while (i < n->len) {
    if (n->digits[i] >= PAO_natural_base) {
      return false;
    }
    i++;
  }
...
bool test_natural_addDigit_2(void) {
  ...
  s = pao_natural_set(alloc, 0, &a); checkStatus(s);
  s = pao_natural_set(alloc, 42, &expected); checkStatus(s);
...
bool test_natural_addDigit_3(void) {
  ...
  s = pao_natural_set(alloc, 314159, &a); checkStatus(s);
  s = pao_natural_set(alloc, 314159, &expected); checkStatus(s);
...
bool test_natural_addDigit_4a(void) {
  ...
  s = pao_natural_setVec(alloc, out_digs, 2, &out); checkStatus(s);
  u32 exp_digs[] = {1, 0, 0};
  s = pao_natural_setVec(alloc, exp_digs, 3, &expected); checkStatus(s);
...
bool test_natural_addDigit_5(void) {
  ...
  s = pao_natural_set(alloc, 314159, &a); checkStatus(s);
  s = pao_natural_set(alloc, 999999, &out); checkStatus(s);
  s = pao_natural_set(alloc, 314160, &expected); checkStatus(s);
...
bool test_natural_compare_1(void) {
  pao_Status s;
  pao_Natural a = pao_natural_new();
  pao_Natural b = pao_natural_new();
  pao_Order out;

  s = pao_natural_set(alloc, 42, &a); checkStatus(s);
  s = pao_natural_set(alloc, 42, &b); checkStatus(s);
  
  out = pao_natural_compare(&a, &b);
...
bool test_natural_compare_2(void) {
  ...
  s = pao_natural_set(alloc, 1, &a); checkStatus(s);
  s = pao_natural_set(alloc, 100, &b); checkStatus(s);
...
bool test_natural_compare_3(void) {
  ...
  s = pao_natural_set(alloc, 100, &a); checkStatus(s);
  s = pao_natural_set(alloc, 1, &b); checkStatus(s);
...
bool test_natural_compare_4(void) {
  ...
  u32 A_DIGS[] = {1, 0};
  s = pao_natural_setVec(alloc, A_DIGS, 2, &a); checkStatus(s);
  s = pao_natural_set(alloc, PAO_natural_base - 1, &b); checkStatus(s);
...
bool test_natural_compare_5(void) {
  ...
  s = pao_natural_setVec(alloc, A_DIGS, 4, &a); checkStatus(s);
  u32 B_DIGS[] = {127, 0, 0, 0};
  s = pao_natural_setVec(alloc, B_DIGS, 4, &b); checkStatus(s);
...
bool test_natural_compareDigit_1(void) {
  ...
  s = pao_natural_set(alloc, 42, &a); checkStatus(s);
  out = pao_natural_compareDigit(&a, 42);
  pao_natural_free(alloc, a);
...
bool test_natural_compareDigit_2(void) {
  ...
  u32 A_DIGS[] = {127, 0, 0, 0};
  s = pao_natural_setVec(alloc, A_DIGS, 4, &a); checkStatus(s);
  out = pao_natural_compareDigit(&a, 1);
  pao_natural_free(alloc, a);
...
bool test_natural_compareDigit_3(void) {
  ...
  u32 A_DIGS[] = {1, 0};
  s = pao_natural_setVec(alloc, A_DIGS, 2, &a); checkStatus(s);
  out = pao_natural_compareDigit(&a, PAO_natural_base-1);
  pao_natural_free(alloc, a);
...
bool test_natural_compareDigit_4(void) {
  ...
  s = pao_natural_set(alloc, 0, &a); checkStatus(s);
  out = pao_natural_compareDigit(&a, 0);
  pao_natural_free(alloc, a);
...
bool test_natural_compareDigit_6(void) {
  ...
  s = pao_natural_set(alloc, 5, &a); checkStatus(s);
  out = pao_natural_compareDigit(&a, 6);
  pao_natural_free(alloc, a);
...
bool test_natural_compareDigit_7(void) {
  ...
  s = pao_natural_set(alloc, 6, &a); checkStatus(s);
  out = pao_natural_compareDigit(&a, 5);
  pao_natural_free(alloc, a);
...
bool test_natural_add_0a(void) {
  ...
  s = pao_natural_set(alloc, 42, &a); checkStatus(s);
  s = pao_natural_set(alloc, 0, &b); checkStatus(s);
  s = pao_natural_set(alloc, 42, &expected); checkStatus(s);
...
bool test_natural_add_0b(void) {
  ...
  s = pao_natural_set(alloc, GARBAGE, &out); checkStatus(s);
  s = pao_natural_set(alloc, 42, &a); checkStatus(s);
  s = pao_natural_set(alloc, 0, &b); checkStatus(s);
  s = pao_natural_set(alloc, 42, &expected); checkStatus(s);
...
bool test_natural_add_1a(void) {
  ...
  s = pao_natural_set(alloc, PAO_natural_base - 1, &a); checkStatus(s);
  s = pao_natural_set(alloc, PAO_natural_base - 1, &b); checkStatus(s);
...
bool test_natural_add_2(void) {
  ...
  pao_Natural a = pao_natural_new();
  pao_Natural b = pao_natural_new();
  pao_Natural out1 = pao_natural_new();
  pao_Natural out2 = pao_natural_new();
  pao_Natural expected = pao_natural_new();

  s = pao_natural_set(alloc, 42, &a); checkStatus(s);
  s = pao_natural_set(alloc, 17, &b); checkStatus(s);
  s = pao_natural_set(alloc, 59, &expected); checkStatus(s);

  s = pao_natural_add(alloc, &a, &b, &out1); checkStatus(s);
  s = pao_natural_add(alloc, &b, &a, &out2); checkStatus(s);
...
bool test_natural_add_3a(void) {
  ...
  s = pao_natural_set(alloc, PAO_natural_base - 1, &out); checkStatus(s);
  s = pao_natural_set(alloc, PAO_natural_base - 1, &b); checkStatus(s);
...
bool test_natural_multDigit_1(void) {
  ...
  s = pao_natural_set(alloc, 314159, &a); checkStatus(s);
  s = pao_natural_set(alloc, 0, &expected); checkStatus(s);
...
bool test_natural_multDigit_5(void) {
  ...
  {
    s = pao_natural_set(alloc, 2, &a); checkStatus(s);
  ...
  {
    s = pao_natural_set(alloc, 4, &a); checkStatus(s);
...
bool test_natural_multDigit_6(void) {
  ...
  {
    s = pao_natural_set(alloc, 12, &a); checkStatus(s);
  ...
  {
    s = pao_natural_set(alloc, 1111, &a); checkStatus(s);
...
bool test_natural_multDigit_7(void) {
  ...
  s = pao_natural_set(alloc, 4, &a); checkStatus(s);
  s = pao_natural_set(alloc, 16, &expected); checkStatus(s);
  s = pao_natural_multDigit(alloc, &a, 4, &out); checkStatus(s);
...
bool test_natural_mult_1(void) {
  ...
  s = pao_natural_set(alloc, 0,      &a);        checkStatus(s);
  s = pao_natural_set(alloc, 314159, &b);        checkStatus(s);
  s = pao_natural_set(alloc, 0,      &expected); checkStatus(s);
...
bool test_natural_mult_5(void) {
  ...
  s = pao_natural_set(alloc, 12345, &a); checkStatus(s);
  s = pao_natural_set(alloc, 67890, &b); checkStatus(s);

  s = pao_natural_mult(alloc, &a, &b, &out1); checkStatus(s);
...
bool test_natural_mult_7(void) {
  ...
  u32 A_DIGS[] = {1, 0};
  s = pao_natural_setVec(alloc, A_DIGS, 2, &a); checkStatus(s);
  s = pao_natural_set(alloc, 2, &b);            checkStatus(s);
...
bool test_natural_mult_8(void) {
  ...
  u32 AB_DIGS[] = {1, 0};
  s = pao_natural_setVec(alloc, AB_DIGS, 2, &a); checkStatus(s);
  s = pao_natural_setVec(alloc, AB_DIGS, 2, &b); checkStatus(s);
...
bool test_natural_mult_9(void) {
  ...
  s = pao_natural_set(alloc, 6, &a); checkStatus(s);
  s = pao_natural_set(alloc, 7, &b); checkStatus(s);
...
bool test_natural_mult_10(void) {
  ...
  const u32 GARBAGE = 0xCAFEBABE % PAO_natural_base;
  s = pao_natural_set(alloc, GARBAGE, &out);    checkStatus(s);
  s = pao_natural_set(alloc, 111,     &a);      checkStatus(s);
  s = pao_natural_set(alloc, 111,     &b);      checkStatus(s);
  s = pao_natural_set(alloc, 12321,   &expected); checkStatus(s);
...
bool test_natural_multBase_2(void) {
  ...
  s = pao_natural_set(alloc, 900000000, &a); checkStatus(s);
  s = pao_natural_setVec(alloc, digits, 3, &expected); checkStatus(s);
  s = pao_natural_multBase(alloc, &a); checkStatus(s);
  s = pao_natural_multBase(alloc, &a); checkStatus(s);
...
bool test_natural_snprint_1(void) {
  ...
  s = pao_natural_setVec(alloc, digits, 3, &A); checkStatus(s);
...
bool test_natural_distanceDigit_1(void) {
  ...
  u32 A_DIGS[] = {1, 0, 0};
  s = pao_natural_setVec(alloc, A_DIGS, 3, &a); checkStatus(s);
...
bool test_natural_distanceDigit_5b(void) {
  ...
  u32 out_digs[] = {1, 0, 0};
  s = pao_natural_setVec(alloc, out_digs, 3, &out); checkStatus(s);
...
bool test_natural_distance_0(void) {
  ...
  s = pao_natural_distance(alloc, &a, &b, &out1); checkStatus(s);
  s = pao_natural_distance(alloc, &b, &a, &out2); checkStatus(s);
...
bool test_natural_distance_2(void) {
  ...
  s = pao_natural_set(alloc, 42, &a); checkStatus(s);
  s = pao_natural_set(alloc, 17, &b); checkStatus(s);
  s = pao_natural_set(alloc, 25, &expected); checkStatus(s);
...
bool test_natural_distance_4a(void) {
  ...
  u32 A_DIGS[3] = {1, 0, 42};
  s = pao_natural_setVec(alloc, A_DIGS, 3, &out); checkStatus(s);
  s = pao_natural_set(alloc, 42, &b); checkStatus(s);
...
bool test_natural_divDigit_1(void) {
  ...
  pao_Natural A = pao_natural_new();
  u32 B = 3;
  pao_Natural Q = pao_natural_new();
  u32 R;

  pao_Natural exp_Q = pao_natural_new();
  u32 exp_R = 2;

  s = pao_natural_set(alloc, 5, &A); checkStatus(s);
  s = pao_natural_set(alloc, 1, &exp_Q); checkStatus(s);
...
bool test_natural_divDigit_2(void) {
  ...
  s = pao_natural_set(alloc, 0, &A); checkStatus(s);
  s = pao_natural_set(alloc, 0, &exp_Q); checkStatus(s);
  s = pao_natural_divDigit(alloc, &A, B, &Q, &R); checkStatus(s);
...
bool test_natural_divDigit_3(void) {
  ...
  s = pao_natural_setVec(alloc, exp_Q_DIGS, 2, &exp_Q); checkStatus(s);
...
bool test_natural_divDigit_4(void) {
  ...
  s = pao_natural_set(alloc, 36, &A); checkStatus(s);
...
bool test_natural_divDigit_6(void) {
  ...
  u32 R;
  s = pao_natural_set(alloc, 5, &A); checkStatus(s);
  s = pao_natural_divDigit(alloc, &A, B, &Q, &R);
  pao_natural_free(alloc, A);
  pao_natural_free(alloc, Q);
  return s == PAO_status_divisionByZero && isAllFree();
}
...
bool test_natural_divDigit_7(void) {
  ...
  s = pao_natural_set(alloc, 42, &A); checkStatus(s);
  s = pao_natural_set(alloc, 42, &exp_Q); checkStatus(s);
...
bool test_natural_div_1(void) {
  ...
  pao_Natural B = pao_natural_new();
  pao_Natural Q = pao_natural_new();
  pao_Natural R = pao_natural_new();
  pao_Natural scratch = pao_natural_new();
  pao_Natural exp_Q = pao_natural_new();
  pao_Natural exp_R = pao_natural_new();

  s = pao_natural_set(alloc, 5, &A);     checkStatus(s);
  s = pao_natural_set(alloc, 1, &exp_Q); checkStatus(s);
  s = pao_natural_set(alloc, 3, &B);     checkStatus(s);
  s = pao_natural_set(alloc, 2, &exp_R); checkStatus(s);

  s = pao_natural_div(alloc, &scratch, &A, &B, &Q, &R); checkStatus(s);
  ...
  pao_natural_free(alloc, B);
  pao_natural_free(alloc, Q);
  pao_natural_free(alloc, R);
  pao_natural_free(alloc, scratch);
  pao_natural_free(alloc, exp_Q);
  pao_natural_free(alloc, exp_R);
  return ok && isAllFree();
}
...
bool test_natural_div_2(void) {
  ...
  s = pao_natural_set(alloc, 0,  &A);    checkStatus(s);
  s = pao_natural_set(alloc, 11, &B);    checkStatus(s);
  s = pao_natural_set(alloc, 0, &exp_Q); checkStatus(s);
  s = pao_natural_set(alloc, 0, &exp_R); checkStatus(s);
...
bool test_natural_div_3(void) {
  ...
  u32 A_DIGS[] = {999999999, 999999999};
  s = pao_natural_setVec(alloc, A_DIGS, 2, &A); checkStatus(s);
  s = pao_natural_set(alloc, 9, &B); checkStatus(s);
  u32 exp_Q_DIGS[] = {111111111, 111111111};
  s = pao_natural_setVec(alloc, exp_Q_DIGS, 2, &exp_Q); checkStatus(s);
...
bool test_natural_div_4(void) {
  ...
  while (pao_natural_compareDigit(&B, 36) == PAO_order_less) {
    s = pao_natural_div(alloc, &scratch, &A, &B, &Q, &R);
    checkStatus(s);

    if (!(pao_natural_compare(&R, &B) == PAO_order_less)) {
      pao_natural_free(alloc, A);
      pao_natural_free(alloc, B);
      pao_natural_free(alloc, Q);
      pao_natural_free(alloc, R);
    ...
    s = pao_natural_addDigit(alloc, &B, 1, &B); checkStatus(s);
  }
  pao_natural_free(alloc, A);
  pao_natural_free(alloc, B);
  pao_natural_free(alloc, Q);
...
bool test_natural_div_5(void) {
  ...
  s = pao_natural_setVec(alloc, A_DIGS, 2, &A); checkStatus(s);
  s = pao_natural_set(alloc, 1, &B); checkStatus(s);
  s = pao_natural_set(alloc, 0, &R); checkStatus(s);

  while (pao_natural_compareDigit(&B, PAO_natural_base) == PAO_order_less) {
    s = pao_natural_div(alloc, &scratch, &A, &B, &Q, &R); checkStatus(s);
    ...
    s = pao_natural_addDigit(alloc, &B, PAO_natural_base/10, &B); checkStatus(s);
  }
  pao_natural_free(alloc, A);
  pao_natural_free(alloc, B);
  pao_natural_free(alloc, Q);
...
bool test_natural_copy_3(void) {
  ...
  u32 A_DIGS[] = {999999999, 999999999};
  s = pao_natural_setVec(alloc, A_DIGS, 2, &a); checkStatus(s);
  s = pao_natural_set(alloc, 123456, &out); checkStatus(s);
...
bool test_natural_growShrink_1(void) {
  pao_Status s;
  pao_Natural A = pao_natural_new();
  u32 B = PAO_natural_base-1;
  pao_Natural C = pao_natural_new();

  s = pao_natural_set(alloc, 0, &A); checkStatus(s);
  s = pao_natural_set(alloc, 0, &C); checkStatus(s);;

  int i = 0;
  while (i < 100) {
    s = pao_natural_addDigit(alloc, &A, B, &C); checkStatus(s);
    s = pao_natural_copy(alloc, &C, &A); checkStatus(s);
    i++;
  }

  while (0 < i) {
    s = pao_natural_distanceDigit(alloc, &A, B, &C); checkStatus(s);
    s = pao_natural_copy(alloc, &C, &A); checkStatus(s);
    i--;
  }
...
bool test_natural_growShrink_2(void) {
  ...
  int i = 0;
  while (i < 100) {
    s = pao_natural_add(alloc, &A, &B, &C); checkStatus(s);
    s = pao_natural_copy(alloc, &C, &A); checkStatus(s);
    i++;
  }

  while (0 < i) {
    s = pao_natural_distance(alloc, &A, &B, &C); checkStatus(s);
    s = pao_natural_copy(alloc, &C, &A); checkStatus(s);
    i--;
  }
...
bool test_natural_growShrink_3(void) {
  ...
  s = pao_natural_set(alloc, 1, &A); checkStatus(s);
  s = pao_natural_set(alloc, 1, &C); checkStatus(s);;

  int i = 0;
  while (i < maxIter) {
    s = pao_natural_multDigit(alloc, &A, B, &C); checkStatus(s);
    s = pao_natural_copy(alloc, &C, &A); checkStatus(s);
    i++;
  }

  while (0 < i) {
    s = pao_natural_divDigit(alloc, &A, B, &C, &R); checkStatus(s);
    s = pao_natural_copy(alloc, &C, &A); checkStatus(s);
    if (R != 0) {
      return false;
    }
...
bool test_natural_growShrink_4(void) {
  ...
  int i = 0;
  while (i < 100) {
    s = pao_natural_addDigit(alloc, &C, B, &C); checkStatus(s);
    i++;
  }

  while (0 < i) {
    s = pao_natural_distanceDigit(alloc, &C, B, &C); checkStatus(s);
    i--;
  }
...
bool test_natural_growShrink_5(void) {
  ...
  int i = 0;
  while (i < 100) {
    s = pao_natural_add(alloc, &C, &B, &C); checkStatus(s);
    i++;
  }

  while (0 < i) {
    s = pao_natural_distance(alloc, &C, &B, &C); checkStatus(s);
    i--;
  }
...
bool test_natural_growShrink_6(void) {
  ...
  s = pao_natural_set(alloc, 1, &A); checkStatus(s);
  s = pao_natural_set(alloc, 8, &B); checkStatus(s);
  s = pao_natural_set(alloc, 1, &C); checkStatus(s);;
  s = pao_natural_set(alloc, 0, &R); checkStatus(s);;

  int i = 0;
  while (i < maxIter) {
    s = pao_natural_mult(alloc, &A, &B, &C); checkStatus(s);
    s = pao_natural_copy(alloc, &C, &A); checkStatus(s);
    i++;
  }

  while (0 < i) {
    s = pao_natural_div(alloc, &scratch, &A, &B, &C, &R); checkStatus(s);
    s = pao_natural_copy(alloc, &C, &A); checkStatus(s);
    if (!pao_natural_isZero(&R)) {
      pao_natural_free(alloc, A);
      pao_natural_free(alloc, B);
      pao_natural_free(alloc, C);
      pao_natural_free(alloc, R);
